...
<section id="cards">
    ...
    <div>
        <div class="dinamic-button button-style hidden-mobile"><a href="<?php echo $datos['bloques_variables'][$inicial]['button']['url']; ?>"><span><?php echo $datos['bloques_variables'][$inicial]['button']['texto_button']; ?></span></a></div>  
    </div>
